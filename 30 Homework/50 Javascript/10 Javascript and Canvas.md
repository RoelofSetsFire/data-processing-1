...
The homework for week4 and 5 can be found in this [reader].
It contains the assignments about JavaScript. JavaScript is the only programming language that is supported by
...
\texttt{canvas}-element provides raster graphics and Scalable Vector
